...
nn_matchC <- function(treat, ord, ratio, max_rat, replace, discarded, distance_ = NULL, exact_ = NULL, caliper_dist_ = NULL, caliper_covs_ = NULL, calcovs_covs_mat_ = NULL, mah_covs_ = NULL, mahSigma_inv_ = NULL, disl_prog = FALSE) {
    .Call(`_MatchIt_nn_matchC`, treat, ord, ratio, max_rat, replace, discarded, distance_, exact_, caliper_dist_, caliper_covs_, calcovs_covs_mat_, mah_covs_, mahSigma_inv_, disl_prog)
}
