...
distC <- function(x) {
    .Call(`_MatchIt_distC`, x)
}

distC2 <- function(x, y) {
    .Call(`_MatchIt_distC2`, x, y)
}
...
do_matchingC <- function(distmat, treat, ord, reuse_max, ratio) {
    .Call(`_MatchIt_do_matchingC`, distmat, treat, ord, reuse_max, ratio)
}
