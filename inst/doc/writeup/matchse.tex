...
balance) is a characteristic of the observed data.  A related argument
has been made in the context of randomized experiments, where
researchers have shown that even small (and statistically
insignificant) differences in important (or what they call in this
literature ``prognostic'') covariates can result in large differences
in the results of the experiment \citep{Altman85,Senn94,PocAssEno02}.
