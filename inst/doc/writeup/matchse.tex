...
the tests frequently conducted in experiments to assess the adequacy
of the randomization, although only as a comparison for a hypothetical
population of questionable relevant to the observed data
\citep{Cochran65}.
