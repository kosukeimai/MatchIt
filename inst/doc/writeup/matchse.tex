...
of $X$ alone can be guaranteed to be a monotonic function of bias
without special assumptions \citep{Stuart??}, and so proper measures
...
although they can have higher variance.  In each case, the statistics
