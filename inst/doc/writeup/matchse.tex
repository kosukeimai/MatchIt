...
there are $n_1$ treated units and $n_0$ control units. Then, the {\it
...
given by,
\begin{eqnarray*}
  {\rm Bias}  & =  & \frac{1}{n_1} \sum_{i\,\in \{T = 1\}} E[Y_i(0) \mid
  T_i = 1, X_i] - \frac{1}{n_0} \sum_{i\,\in \{T = 0\}} E[Y_i(0) \mid T_i = 0, X_i], \\
  & = & \int E[Y(0) \mid T = 1, X] d\widetilde{F}(X \mid T =
  1) - \int E[Y(0) \mid T = 0, X] d\widetilde{F}(X \mid T =
  0), \\
  & = & \int E[Y(0) \mid T = 0, X] \,[d\widetilde{F}(X \mid T
  = 1) - d\widetilde{F}(X \mid T = 0)] \\
   &  & + \int\left\{ E[Y(0) \mid T = 1, X] - E[Y(0) \mid T = 0,
...
\begin{eqnarray*}
  {\rm Discrepancy}  
  & =  & \frac{1}{n_1} \sum_{i\,\in \{T = 1\}}
  Y_i(0) - \frac{1}{n_0} \sum_{i\,\in \{T = 0\}}  Y_i(0), \\
  & =  & \frac{1}{n_1} \sum_{i\,\in \{T = 1\}}
  (g_0(X_i) + U_{0i}) - \frac{1}{n_0} \sum_{i\,\in \{T = 0\}}  (g_0(X_i)
  + U_{0i}), \\
  & = & \int g_0(X) \,[d\widetilde{F}(X \mid T
  = 1) - d\widetilde{F}(X \mid T = 0)] +  
  \int U_0 \,[d\widetilde{F}(U_0 \mid T = 1) - d\widetilde{F}(U_0 \mid
  T = 0)]   
\end{eqnarray*}
...
\begin{eqnarray*}
  {\rm Discrepancy} & = & \int g_0(X, U_0) [d\widetilde{F}(X, U_0 \mid
  T = 1) - d\widetilde{F}(X, U_0 \mid
  T = 0)] 
\end{eqnarray*}
Finally, note that
\begin{eqnarray*}
