...
The advantage of matching is that it is normally relatively robust to
small changes in procedures, and of course it produces a data set that
is by design less sensitive to model assumptions.  However, like any
method, using it badly or to ill effecxt is certainly possible.  Thus,
in this section, we discuss what can go wrong and how we might avoid
these problems.  We discuss five issues, some of which have come up
already.

First, the curse of dimensionality affects balancing diagnostics of
course, and we may well miss a higher dimensional imbalance when
checking lower dimensional summaries.  Even if we were not interested
in testing this with our parametric model, and 
