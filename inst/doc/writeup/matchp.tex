...
measured in months passed from the submission of an application.  In
our analysis, we focus on the estimation of the marginal effect of the
binary treatment variable of the existence of a Democratic Senate
majority, which is one of the seven oversight variables. We do not
control for the remaining six oversight variables because they are
conceptually and statistically highly related, and in part
consequences of, the Democratic Senate majority variable.
