...
observations are dropped.\footnote{In this situation without a
  maintained or correct model, no estimator is ``self-efficient'' and
  so the usual ``more data are better'' rule does not apply.  See
