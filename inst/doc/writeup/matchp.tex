...
worse, or vice versa.\footnote{To see this, consider the commonly-used
  ...
  \sqrt{\frac{\sigma^2_t}{r} + \frac{\sigma^2_c}{1-r}}$ where
  $\sigma^2_t=\sum_{i=1}^n t_i(X_i - \overline{X}_t)^2/(n_t-1)$ and
  $\sigma^2_c=\sum_{i=1}^n (1-t_i)(X_i - \overline{X}_t)^2/(n_c-1)$
  represent the variance of $X$ for the treated and control groups,
  $n_t$ and $n_c$ are the sample size for the treatment and control
  groups, and $r=n_t/n$.  The difference in sample means as a measure
  of balance in the numerator is thus distorted in the t-test due to
  the three factors in the denomenator: the total number of remaining
  observations $n$, the ratio of remaining treated units to the total
  number of observations $r=n_t/n$, and the variance of $X$ for
