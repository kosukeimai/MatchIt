...
regressiosn that social scientists typically run.  The new methods
...
used to describe the same underlying concepts, has limited the spread
of these powerful techniques to much of the social sciences.
...
to their data analysis procedures and then use whichever models they
were previously accustomed to using to analyze the preprocessed data
rather than the raw data.  All of the intuition, diagnostics, and
