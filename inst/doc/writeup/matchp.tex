...
\title{Matching as Nonparametric Preprocessing\\
  ...
  Gabe Linz for many helpful comments; and the National Institutes of Aging
...
parentheses.  Since these are potential outcomes, their values remain
the same regardless of whether the treatment is in fact applied in
district $i$ or not.  However, the key point is that since the
