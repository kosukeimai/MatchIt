...
Our approach is similar in spirit to, but a generalization of the
ideas in, \citet{ImaDyk03}, \citet{RosRub84a}, \citet{Rubin79}, and
...
within each pair of units.\footnote{Formally, ignorability, by which
  ...
  $X$, and balance in Equation \ref{balance} guarantee valid
  inferences, which can be written as $P(Y(0)|T=1)=P(Y(0)|T=0)$ and
  $P(Y(1)|T=1)=P(Y(1)|T=0)$.}
