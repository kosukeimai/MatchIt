...
well as to the parametric bias adjustment for one form of matching by
...
implemented).  Our idea is also similar in spirit to methods in other
...
\citep[][Ch.8]{Bishop95}.  To our knowledge, the present paper is the
first to propose and work out the conditions for matching as a general
method of nonparametric preprocessing, suitable for improving any
parametric method.
