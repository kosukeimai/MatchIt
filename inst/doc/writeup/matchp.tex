...
statistical procedures.  Moreover, they are spread over a range of
different languages and packages, which would normally makes it
impractical to use more than one for any applied project
\citep{AbaDruLeb02, BecIch02, BerKos03, CumMcKWei03, Hansen05,
  LeuSia04, Parsons00, Parsons01, Sekhon04}.  Thus, as a companion to
