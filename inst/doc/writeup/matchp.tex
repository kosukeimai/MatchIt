% todo:
% - matching isn't an estimator; we just switch a lame para for a good
% one
% - doubly robust
%- see lechner on bounds on QOI even without dropping Ts.  siaw.unisg.ch
% - drop tstats replace with bias diff
% - fix examples
