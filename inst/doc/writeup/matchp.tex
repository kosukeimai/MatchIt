...
causal effect,'' which is the simplest insample definition available,
...
fixed (or unit specific) definition of a causal effect:
\begin{equation}
  \label{rce}
...
\begin{align}
  ...
  Y_i(0)\mid X_i]\notag\\ 
  & = \frac{1}{\sum_{i=1}^n t_i}\sum_{i:t_i=1} \mu_1(X_i) - \mu_0(X_i).
\end{align}
...
for population and sample are normally identical, although the
