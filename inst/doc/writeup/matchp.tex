...
indeed the farther the extrapolation is from the data the larger model dependence can become.  For example, asking in 2001 
what Iraq would
...
explanatory variables, making three typical assumptions,\footnote{First, the
  ...
  candidates.}  which, for our purposes, we do not challenge.  Instead, we focus on the sensitivity of inferences
