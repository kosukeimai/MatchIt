...
inferences.\footnote{Our definition of ``observational data,'' which
  ...
  in some.  In some fields, only deviations from random assignment
  would be called observational.  We choose our more expansive
  definition to emphasize the necessity of assumptions in general
