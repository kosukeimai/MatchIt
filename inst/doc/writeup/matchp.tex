...
seconds and, according to some textbook ways of proceeding, it would
be time to write up the results.
...
only choose one, and rarely more than 5--10, to present in a paper.
Yet, we know that the dependence of our estimates on these modeling
assumptions means that different specifications can produce very
...
We attack this problem by drawing on a new statistics literature
concerned with nonparametric, non-model-based causal inference based
on matching.  This work offers considerable promise for increasing the
reliability and validity of causal inferences by reducing or
eliminating the role of functional form and other assumptions of
parametric models.  The statistical literature on matching has grown
quite sophisticated, but, from the point of view of the practical
researcher, it looks like a cacophony of conflicting techniques,
practices, conventions, and rules of thumb.  Valid methods for
computing standard errors and confidence intervals are even more
