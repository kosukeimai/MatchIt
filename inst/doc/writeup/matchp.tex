...
population or population subgroup.  This leads to two choices for
quantities of interest, for either realized and random causal effects
(we show them here for the latter).  First is the population average
...
The alternative choice of a target quantity of interest is the
...
may be omitted without any bias resulting (although the variance may
increase).  Random assignment guarantees that $t_i$ is unrelated to
...
Classical randomized Experiments are a true ideal type,
...
Researchers willing to assume a parametric model that generated their
data, up to but not including some unknown parameters, should specify
and directly estimate this parametric model.  Preprocessing with
