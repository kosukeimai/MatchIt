...
$-33.1$ months with an estimated standard error $4.1$, indicating that
...
likelihood estimates of insample ATT across potential specifications
...
\begin{figure}[t] 
 \begin{center}
  ...
  \caption{Kernel density plot (a smoothed histogram)
    of the estimated insample average treatment effect for the treated
    (ATT) of the Democratic Senate majority on FDA drug approval time
    across $262,143$ specifications. The solid line presents a density
    plot of the maximum likelihood estimates of ATT using the matched
