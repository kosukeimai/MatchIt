...
balance, we should not even expect them in to be monotonic in balance:
the t-test can get apparently better while balance gets worse, or vice
versa.  Using hypothesis statistics to assess balance in matching
applications should end.
\begin{figure}[t] 
 \begin{center}
