...
\begin{abstract}
  ...
  perspective on this literature that enables researchers to
  preprocess their data (such as with the easy-to-use software we
  offer) and then to apply whatever familiar techniques they would
  have used anyway.  Under our approach, instead of using matching to
  replace existing parametric methods, we use it to make existing
