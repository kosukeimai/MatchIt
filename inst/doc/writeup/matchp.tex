...
within each pair of units.\footnote{Formally, ignorability, the
  independence of $T$ and the potential outcomes given $X$, and
  balance in Equation \ref{balance} guarantees valid inferences, which
...
bias, but decrease efficiency and as a result increase mean square
...
\citet[][Ch.3]{Rosenbaum02}.  Indeed, preprocessing can help
