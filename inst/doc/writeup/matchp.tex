...
{\bf The estimated average treatment effect (ATE) is $-31.6$ months
  with estimated standard error $10.3$, indicating that a Democratic
  Senate majority significantly decreased the average approval time of
  new drugs and therefore contradicting Carpenter's hypothesis.}
