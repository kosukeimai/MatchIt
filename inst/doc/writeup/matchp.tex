...
to make causal inferences.  For example, when thought of in the way we
...
{\bf this sounds a bit awkward to me. should we delete ``but not
  including''?}, should specify and directly estimate this model.
Preprocessing data with matching procedures is suboptimal in this
situation.  Of course, few researchers with real observational data
sets have this kind of knowledge and as a result some choices need to
be made among the range of possible parametric models. {\bf the
  dilemma is that although researchers don't know the true parametric
  model, they must assume one as if they know it...}

{\bf the transition here is a bit awkward.} We thus begin by
...
been used in the social sciences.  First define the model's chosen
...
% ki: that's fine by me. the sentence you inserted earlier made this clear.
