...
same size \citep{RubTho92, RubTho96}.  Similarly, \cite{ImaVan04}
...
correlation between $X$ and the outcome.  The bias and variance
reduction approximations all relate to selecting matched rather than
random samples, of the same size.  In situations where matching is
used badly, and so too many observations are dropped, the variance
results are more complicated and require more judgment.
