...
that are widely, but incorrectly, perceived to be more difficult than
causal inference.
...
commonly used parametric methods.\footnote{We assume throughout that
  every unit within each treatment group receives the same treatment.
  This assumption would be violated in our running example if the
