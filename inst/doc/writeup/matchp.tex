...
dashed line, range from $-0.64$ to $-0.2$, signifying female
visibility causes voters to perceive candidates as more liberal.  The
point estimate from the full data that controls for all six
covariates, signified by the vertical arrow, appears conservative
compared to this range.  Yet estimates from the pre-processed data,
plotted by the solid line, stand in stark contrast the to estimates
from the raw data.  The range of coefficient estimates is
...
\begin{figure}[t] 
 \begin{center}
  ...
  \caption{Kernel density plot of estimated average treatment effect of
    ...
    possible specificatons with the Carpenter data. The solid line
