...
\begin{abstract}
  ...
  few model specifications, authors usually choose the presented estimates from numerous
...
that depend on observed covariates, such as matched pairs or randomized blocks, in experiments
and stratified sampling in surveys are
