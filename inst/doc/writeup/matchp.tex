...
rather than a population density.\footnote{To be more specific, the
  ...
  of elements in the set $A$.  The denominator in (\ref{balance}) is
  $\sum_{i=1}^n t_i$ on the left side and $\sum_{i=1}^n (1-t_i)$ on
  the right.}  The simplest (although not necessarily the best) way to
...
data set with very few observations that lead to a parametric analysis
...
produces imbalance.  With these deletions, the data set is now highly
