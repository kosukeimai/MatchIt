...
when estimating the effect of $t_i$ and so we drop $X$ and replace
(\ref{matt}) with
\begin{align}
  \label{smatt}
...
$X_i$ and, by so doing, eliminates the problem of model dependence.
...
line for the treated group, $E(Y_i\mid
X_i,t_i=1)=\alpha+\beta+X_i\gamma$, and the gray solid line is for the
