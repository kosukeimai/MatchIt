...
\begin{abstract}
  ...
  uncertainty, theoretical analysis, and practical advice.  We offer a
  unified perspective on matching as a method of nonparametric
  preprocessing for the purpose of improving parametric methods.  This
  ...
  methods work better, such as by giving causal estimates that are
  considerably less model-dependent.
\end{abstract}
