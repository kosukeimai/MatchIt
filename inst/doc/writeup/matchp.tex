...
as a companion to and in the same spirit as this paper, we have
created a software package (called MatchIt, available at
...
incorporate existing packages, and across all the specialized
techniques, we offer a single, simple, and unified syntax.
