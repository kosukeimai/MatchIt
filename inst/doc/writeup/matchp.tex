...
\caption{Remaining covariate imbalance after matching for the FDA data. 
  ...
  their percent balance improvement for each covariate of Model 1 of
...
without sacrificying the effeciency of estimates. For example, the
mean length of resulting 95\% confidence interval for the estimated
insample ATT (averaged over all of the $262,143$ specifications) is
...
significantly shorter than that for the orignal data (63.3). As
