...
\begin{figure}[tbp]
  \begin{center}
\includegraphics{figs/-028}
%    \includegraphics[scale=0.25]{figs/qqplotnn}
%    \includegraphics[scale=0.25]{figs/qqplotnn2} 
    \hfill
    \caption{SWEAVE Sample diagnostic QQ plots: Nearest Neighbor matching
...
\begin{figure}[tbp]
  \begin{center}
\includegraphics{figs/-033}
%    \includegraphics[scale=.25]{figs/qqplotsub}
%    \includegraphics[scale=.25]{figs/qqplotsub2}
    \hfill
    \caption{SWEAVE Sample diagnostic QQ plots: Subclassification with
...
\begin{figure}[tbp]
  \begin{center}
\includegraphics{figs/-034}
    %\includegraphics[scale=0.5]{figs/jitterplotsub}
    \hfill
    \caption{SWEAVE Sample diagnostic jitter plot: Subclassification with
      \MatchIt\ call \texttt{matchit(treat ~ re74 + re75 + educ +
        black + hispan + age, data = lalonde, method = "subclass")
