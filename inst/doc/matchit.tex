...
\item \texttt{distance}, specifies the method used to estimate the
  ...
  (\cite{RosRub83a}).  The distance measures used are the predicted
...
\MatchIt. First, we describe a simple difference-in-means approach to
estimate the average treatment effect. Next, we describe our
...
({\tt weights} from the \MatchIt\ object).
