...
units are the same.  These two binary covariates form three
...
presented in the right column of the first table is a measure of how
close covariates between treated and control groups are.  For a formal
definition, see Subsection~\ref{cmd:sum}.
