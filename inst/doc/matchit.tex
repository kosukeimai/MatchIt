\documentclass[oneside,letterpaper,titlepage]{book}
\usepackage{graphicx}
\usepackage{natbib}
...
\section{Example Data: National Supported Work Demonstration}
\label{sec:lalonde}
...
this section, and Section~\ref{sec:matchit} lists all possible
...
also want to proceed to Section~\ref{sec:balance} to learn about
...
on the same idea summarized in Section~\ref{sec:balance-sum} and
...
\subsection{Example 1: Exact matching}
...
Sections~\ref{sec:analysis}~and~\ref{sec:match.data} for the
...
\subsection{Example 2: Nearest neighbor matching}
...
\begin{figure}[tbp]
  \begin{center}
\includegraphics[width=2.75in, height=2.75in]{figs/qqplotnn1.pdf}\includegraphics[width=2.75in, height=2.75in]{figs/qqplotnn2.pdf}    %\includegraphics[width=3in, height=3in]{figs/qqplotnn}
...
\subsection{Example 3: Subclassification}
...
\begin{figure}[tbp]
  \begin{center}
\includegraphics[width=2.75in, height=2.75in]{figs/qqplotsub1.pdf}\includegraphics[width=2.75in, height=2.75in]{figs/qqplotsub2.pdf}    %\includegraphics[width=3in, height=3in]{figs/qqplotsub}
...
specify specific covariates to plot by entering names of covariates in
\texttt{which.xs}.  \item Jitter plots of the propensity score for
treated and control
