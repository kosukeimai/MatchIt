...
\noindent \# conduct full matching using the propensity score based on logistic regression 
\begin{Schunk}
\begin{Sinput}
...
\noindent \# optimal ratio matching using the propensity score based on logistic regression
\begin{Schunk}
\begin{Sinput}
