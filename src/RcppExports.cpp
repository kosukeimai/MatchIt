...
// nn_matchC
IntegerMatrix nn_matchC(const IntegerVector& treat, const IntegerVector& ord, const IntegerVector& ratio, const int& max_rat, const bool& replace, const LogicalVector& discarded, const Nullable<NumericVector>& distance_, const Nullable<IntegerVector>& exact_, const Nullable<double>& caliper_dist_, const Nullable<NumericVector>& caliper_covs_, const Nullable<NumericMatrix>& calcovs_covs_mat_, const Nullable<NumericMatrix>& mah_covs_, const Nullable<NumericMatrix>& mahSigma_inv_, const bool& disl_prog);
RcppExport SEXP _MatchIt_nn_matchC(SEXP treatSEXP, SEXP ordSEXP, SEXP ratioSEXP, SEXP max_ratSEXP, SEXP replaceSEXP, SEXP discardedSEXP, SEXP distance_SEXP, SEXP exact_SEXP, SEXP caliper_dist_SEXP, SEXP caliper_covs_SEXP, SEXP calcovs_covs_mat_SEXP, SEXP mah_covs_SEXP, SEXP mahSigma_inv_SEXP, SEXP disl_progSEXP) {
BEGIN_RCPP
    ...
    rcpp_result_gen = Rcpp::wrap(nn_matchC(treat, ord, ratio, max_rat, replace, discarded, distance_, exact_, caliper_dist_, caliper_covs_, calcovs_covs_mat_, mah_covs_, mahSigma_inv_, disl_prog));
...
static const R_CallMethodDef CallEntries[] = {
    {"_MatchIt_nn_matchC", (DL_FUNC) &_MatchIt_nn_matchC, 14},
